        ...
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="tier" class="control-label">Tier <b style="background-color:#17078D;font-size:1rem;padding:2px 7px;border-radius:100px;font-weight:600;">ARIX</b></label>
                        <div>
