...
const ScreenBlock = ({ title, image, message, onBack, onRetry }: ScreenBlockProps) => (
    <PageContentBlock>
        <div css={tw`flex justify-center`}>
            <div css={tw`w-full sm:w-3/4 md:w-1/2 p-12 md:p-20 bg-gray-600 rounded-box text-center relative`}>
                ...
                <p css={tw`text-sm text-gray-200 mt-2`}>{message}</p>
            </div>
        </div>
    </PageContentBlock>
);
...
const PremiumFeature = () => (
    <PageContentBlock>
        <div css={tw`flex justify-center`}>
            <div
                css={tw`w-full sm:w-3/4 md:w-1/2 p-12 md:px-16 md:pt-10 md:pb-14 bg-gray-700 rounded-box text-center relative`}
            >
                <StarIcon className={'w-24 text-yellow-500 mx-auto mb-4'} />
                <h2 css={tw`text-gray-50 font-bold text-4xl`}>Premium Feature</h2>
                <p css={tw`text-sm text-gray-200 mt-2`}>
...
export { ServerError, NotFound, PremiumFeature };
