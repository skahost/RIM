...
export default ({ server, count }: { server: Server; count: number }) => {
    ...
    return (
        <>
            <CardAnimator
                className='bg-gray-700 backdrop boxBorder overflow-hidden rounded-box'
                style={{ animationDelay: `${count * 100}ms` }}
            >
                <div
                    className='flex z-10 items-center justify-between bg-center bg-cover bg-no-repeat px-6 pt-5 pb-10 relative'
                    css={`
                ...
                >
                    <div
                        ...
                        css={'background-color:color-mix(in srgb, rgb(var(--gray700-default)) 65%, transparent);'}
                    />
                ...
                <div className={'px-6 pb-5'}>
                    <Link to={`/server/${server.id}`} className={classNames(styles.button, styles.text, 'w-full')}>
