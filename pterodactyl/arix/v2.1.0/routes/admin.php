...
use Pterodactyl\Http\Middleware\Admin\Arix\ArixHandler;
...
Route::group(['prefix' => 'arix'], function () {
    // Frontend entry for the Arix editor.
    Route::get('/', [Base\IndexController::class, 'index']);

    Route::group(['prefix' => 'api', 'middleware' => [ArixHandler::class]], function () {
        ...
        Route::get('/link', [Admin\Arix\ArixLinkController::class, 'index'])->name('admin.arix.links');
        Route::post('/link', [Admin\Arix\ArixLinkController::class, 'store']);

        Route::get('/preset', [Admin\Arix\ArixPresetController::class, 'index'])->name('admin.arix.preset');
        Route::post('/preset', [Admin\Arix\ArixPresetController::class, 'import'])->name('admin.arix.preset.import');
    });

    // Render all non-API Arix editor routes in React.
