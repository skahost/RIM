...
class SubuserCreationService
{
     ...
     * @throws \Throwable
     */
    public function handle(Server $server, string $email, array $permissions, ?CarbonInterface $expiresAt = null): Subuser
    {
        return $this->connection->transaction(function () use ($server, $email, $permissions, $expiresAt) {
            try {
